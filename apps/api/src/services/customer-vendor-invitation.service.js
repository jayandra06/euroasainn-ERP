...
import { CustomerVendorInvitation } from '../models/customer-vendor-invitation.model';
...
export class CustomerVendorInvitationService {
    ...
    async acceptInvitation(token) {
        ...
        if (invitation.vendorOrganizationId) {
            ...
            await organizationService.addCustomerToVendorVisibility(invitation.vendorOrganizationId.toString(), invitation.customerOrganizationId.toString());
        }
     ...
     */
    async getCustomerInvitations(customerOrganizationId) {
     ...
     */
    async checkVendorEmailExists(email) {
...
//# sourceMappingURL=customer-vendor-invitation.service.js.map