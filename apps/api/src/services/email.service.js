...
export class EmailService {
    async sendInvitationEmail({ to, firstName, lastName, organizationName, organizationType, invitationLink, portalLink: _portalLink, temporaryPassword: _temporaryPassword, invitedByCustomerName, }) {
        try {
    ...
    async sendWelcomeEmail({ to, firstName, lastName, portalLink, temporaryPassword, organizationType, isExternalVendor = false, }) {
        try {
    ...
    async sendUserInvitationEmail({ to, firstName, lastName, portalType, portalLink, temporaryPassword, }) {
        try {
    ...
    async sendEmployeeInvitationEmail({ to, firstName, lastName, organizationName, onboardingLink, }) {
        try {
    ...
    async sendPaymentSuccessEmail({ to, firstName, lastName, organizationName, amount, currency, portalLink, }) {
        try {
    ...
    async sendPaymentFailedEmail({ to, firstName, lastName, organizationName, amount, currency, }) {
        try {
    ...
    async sendPaymentProcessingEmail({ to, firstName, lastName, organizationName, amount, currency, }) {
        try {
    ...
    async sendExistingVendorInvitationEmail({ to, firstName, lastName, customerOrganizationName, acceptLink, declineLink, }) {
        try {
     ...
     */
    async sendRFQNotificationEmail({ to, firstName, lastName, customerOrganizationName, rfqNumber, rfqTitle, rfqLink, }) {
        try {
    ...
    async sendQuotationNotificationEmail({ to, firstName, lastName, vendorOrganizationName, quotationNumber, rfqNumber, quotationLink, quotationDetails, }) {
        try {
     ...
     */
    async sendQuotationFinalizedEmail({ to, firstName, lastName, vendorOrganizationName: _vendorOrganizationName, quotationNumber, rfqNumber, customerOrganizationName, quotationLink, totalAmount, currency, }) {
        try {
     ...
     */
    async sendBankingDetailsEmail({ to, firstName, lastName, vendorOrganizationName, quotationNumber, rfqNumber, bankingDetails, rfqLink, }) {
        try {
     ...
     */
    async sendPaymentProofEmail({ to, firstName, lastName, customerOrganizationName, quotationNumber, rfqNumber, paymentProof, rfqLink, }) {
        try {
      ...
      `;
        ...
        <div style="margin: 20px 0;">
          ...
          <ul style="list-style: none; padding: 0;">
            ${paymentProof.proofDocuments.map((doc, _index) => `
     ...
     */
    async sendPaymentApprovalEmail({ to, firstName, lastName, vendorOrganizationName, quotationNumber, rfqNumber, rfqLink, }) {
        try {
     ...
     */
    async sendShippingDecisionEmail({ to, firstName, lastName, customerOrganizationName, quotationNumber, rfqNumber, shippingOption, shippingDetails, rfqLink, }) {
        try {
     ...
     */
    async sendVendorShippingDetailsEmail({ to, firstName, lastName, vendorOrganizationName, quotationNumber, rfqNumber, shippingDetails, rfqLink, }) {
        try {
