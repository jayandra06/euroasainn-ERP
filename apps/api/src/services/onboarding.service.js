...
export class OnboardingService {
    ...
    async submitCustomerOnboarding(data, token) {
    ...
    async submitVendorOnboarding(data, token) {
        // Verify invitation token
        const invitation = await this.getInvitationByToken(token);
    ...
    async getCustomerOnboardings(filters) {
        const query = {};
    ...
    async getVendorOnboardings(filters) {
        const query = {};
        if (filters?.organizationId) {
            query.organizationId = filters.organizationId;
        }
    ...
    async getCustomerOnboardingById(id) {
    ...
    async getVendorOnboardingById(id) {
    ...
    async approveCustomerOnboarding(id) {
    ...
    async rejectCustomerOnboarding(id, rejectionReason) {
        const onboarding = await CustomerOnboarding.findById(id);
        if (!onboarding) {
            throw new Error('Customer onboarding not found');
        }
    ...
    async approveVendorOnboarding(id) {
    ...
    async rejectVendorOnboarding(id, rejectionReason) {
        const onboarding = await VendorOnboarding.findById(id);
        if (!onboarding) {
            throw new Error('Vendor onboarding not found');
        }
