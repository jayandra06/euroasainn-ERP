    ...
    try {
        ...
        if (oldTechOrg) {
            ...
            if (usersInOldOrg.length > 0) {
                ...
                await User.updateMany({ organizationId: oldTechOrg._id }, { organizationId: euroasiannGroupId });
            ...
            if (licensesInOldOrg.length > 0) {
                ...
                await License.updateMany({ organizationId: oldTechOrg._id }, { organizationId: euroasiannGroupId });
            }
        ...
        if (oldAdminOrg) {
            ...
            if (usersInOldOrg.length > 0) {
                // Migrate users to Euroasiann Group
                await User.updateMany({ organizationId: oldAdminOrg._id }, { organizationId: euroasiannGroupId });
            ...
            if (licensesInOldOrg.length > 0) {
                ...
                await License.updateMany({ organizationId: oldAdminOrg._id }, { organizationId: euroasiannGroupId });
            }
            // Delete the old organization
