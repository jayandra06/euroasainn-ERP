...
import { MdCheckCircle, MdError, MdWarning, MdStar, MdPerson, } from 'react-icons/md';
// Mock data
...
export function PerformanceSLAAnalytics() {
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="space-y-3">
          {vendorRankingData.map((vendor, index) => {
            ...
            return (<div key={index} className={`p-4 rounded-lg ${isYou ? 'bg-blue-50 dark:bg-blue-950/20 border-2 border-blue-300 dark:border-blue-700' : 'bg-[hsl(var(--secondary))]'}`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${index === 0 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600 text-white' :
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" style={{ width: `${vendor.score}%` }}/>
                </div>
              </div>);
        })}
        </div>
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="space-y-3">
          {recentComplaints.map((complaint, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--secondary))]">
              <div className="flex items-center justify-between">
                <div>
                ...
                <span className={`px-3 py-1 text-xs font-semibold rounded-full ${complaint.status === 'Resolved'
...
//# sourceMappingURL=PerformanceSLAAnalytics.js.map