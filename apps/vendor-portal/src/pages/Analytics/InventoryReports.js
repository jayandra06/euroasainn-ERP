...
import { MdInventory, MdWarning, MdTrendingUp, MdTrendingDown, MdCategory, } from 'react-icons/md';
// Mock data
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="space-y-4">
          {stockLevelsByCategory.map((category, index) => {
            ...
            return (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--secondary))]">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {isLowStock ? (<span className="px-3 py-1 text-xs font-semibold rounded-full bg-red-100 dark:bg-red-900 text-[hsl(var(--foreground))] font-semibold">
                      Low Stock
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div className={`h-2 rounded-full ${isLowStock ? 'bg-red-600' : stockPercent > 80 ? 'bg-orange-600' : 'bg-emerald-600'}`} style={{ width: `${stockPercent}%` }}/>
                </div>
              </div>);
        })}
        </div>
      ...
      <div className="p-6 rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/20 shadow-sm">
        ...
        <div className="space-y-3">
          {reorderAlerts.map((alert, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--card))] border border-red-200 dark:border-red-800">
              <div className="flex items-center justify-between mb-2">
                <div>
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="mt-4 space-y-2">
          {stockAgingData.map((item, index) => (<div key={index} className="p-3 rounded-lg bg-[hsl(var(--secondary))]">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <span className={`px-2 py-1 text-xs font-semibold rounded-full ${item.status === 'Fast-moving'
...
//# sourceMappingURL=InventoryReports.js.map