...
import { MdSearch, MdFilterList, MdDelete, MdEdit, MdClose, MdPersonAdd } from "react-icons/md";
...
export default function AssignRolesPage() {
  ...
  const usersQuery = useQuery({
    queryKey: ["vendor-users", currentPage, itemsPerPage, searchQuery, roleFilter],
    queryFn: async () => {
  ...
  const assignRoleMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["vendor-all-users"] });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Manage user roles and permissions for Vendor Portal
          </p>
        </div>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(opt: any) => setEditingRoleId(opt?.value || null)}
                  />
                </div>
