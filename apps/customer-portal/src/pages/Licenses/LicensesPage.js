    ...
    const columns = [
        ...
        },
        {
            ...
            render: (item) => {
                ...
                return (<span className={cn('text-gray-600 dark:text-gray-400', isExpired && 'text-red-600 dark:text-red-400')}>
        ...
        },
        {
          ...
          {item.usageLimits?.vessels !== undefined && (<div className="text-gray-600 dark:text-gray-400">
