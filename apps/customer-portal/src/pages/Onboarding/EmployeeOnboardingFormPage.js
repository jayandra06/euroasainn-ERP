...
import { getCountryOptions, getCountryCodeOptions, getCountryCodeByName, getBankFieldLabel, getBankFieldPlaceholder } from '../../utils/countries';
import { SearchableSelect } from '../../components/shared/SearchableSelect';
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:3000';
// Helper function to get available identity document types based on country
const getIdentityDocumentTypes = (country) => {
    if (country === 'India') {
        return [
...
const getPaymentIdentityTypes = (country) => {
    if (country === 'India') {
        return [
...
export function EmployeeOnboardingFormPage() {
    ...
    if (loadingInvitation) {
        return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center">
    ...
    if (!token || errors.token) {
        return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-6">
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-800/50 p-4 sm:p-6 lg:p-8 overflow-hidden">
          {errors.submit && (<div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <div className="flex-shrink-0">
                      {fileUploads.profilePhoto ? (<img src={URL.createObjectURL(fileUploads.profilePhoto)} alt="Profile" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-2 border-gray-300 dark:border-gray-600"/>) : formData.profilePhoto ? (<img src={formData.profilePhoto} alt="Profile" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-2 border-gray-300 dark:border-gray-600"/>) : (<div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center border-2 border-gray-300 dark:border-gray-600">
                          <MdPerson className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400"/>
                        </div>)}
                    </div>
                    <div className="flex-1 w-full sm:w-auto">
                      <input type="file" accept="image/*" onChange={(e) => handleFileUpload('profilePhoto', e.target.files?.[0] || null)} className="hidden" id="profilePhoto-upload"/>
                      <label htmlFor="profilePhoto-upload" className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <div>
                  ...
                  <input type="text" value={formData.fullName} readOnly disabled className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed" placeholder="Full name (pre-filled from invitation)"/>
                ...
                <div>
                  ...
                  <input type="email" value={formData.email} readOnly className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed" placeholder="Email (pre-filled from invitation)"/>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <div className="w-full sm:w-40">
                      <SearchableSelect options={countryCodeOptions} value={formData.phoneCountryCode} onChange={(selectedCode) => setFormData({ ...formData, phoneCountryCode: selectedCode })} placeholder="Search country code..." className={errors.phoneCountryCode ? 'border-red-500' : ''} required/>
                    </div>
        ...
        }} className={cn('flex-1 min-w-0 px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.phone ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter phone number" required/>
                  </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  ...
                  <input type="text" value={formData.addressLine1} onChange={(e) => setFormData({ ...formData, addressLine1: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.addressLine1 ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Street address, P.O. box"/>
                ...
                <div className="sm:col-span-2">
                  ...
                  <input type="text" value={formData.addressLine2} onChange={(e) => setFormData({ ...formData, addressLine2: e.target.value })} className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Apartment, suite, unit, building, floor, etc."/>
                </div>

                <div>
                  <SearchableSelect options={countryOptions} value={formData.country} onChange={(selectedCountry) => {
            ...
            setFileUploads((prev) => ({
        ...
        }} placeholder="Search and select country..." label="Country" required error={!!errors.country} className={cn(errors.country && 'border-red-500')}/>
                ...
                <div>
                  ...
                  <input type="text" value={formData.state} onChange={(e) => setFormData({ ...formData, state: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.state ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter state or province"/>
                ...
                <div>
                  ...
                  <input type="text" value={formData.city} onChange={(e) => setFormData({ ...formData, city: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.city ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter city"/>
                ...
                <div>
                  ...
                  <input type="text" value={formData.zipCode} onChange={(e) => setFormData({ ...formData, zipCode: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.zipCode ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter zip/postal code"/>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.accountNumber} onChange={(e) => setFormData({ ...formData, accountNumber: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.accountNumber ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter account number"/>
                ...
                <div>
                  ...
                  <input type="text" value={formData.ifscOrSwift} onChange={(e) => setFormData({ ...formData, ifscOrSwift: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.ifscOrSwift ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder={formData.country ? getBankFieldPlaceholder(formData.country) : 'Enter IFSC or SWIFT code'}/>
                ...
                <div className="sm:col-span-2">
                  ...
                  <input type="text" value={formData.bankName} onChange={(e) => setFormData({ ...formData, bankName: e.target.value })} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.bankName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter bank name"/>
            ...
            <div>
              ...
              {errors.identityDocuments && (<p className="mb-4 text-sm text-red-500">{errors.identityDocuments}</p>)}
              {!formData.country && (<p className="mb-4 text-sm text-amber-600 dark:text-amber-400">
                  Please select a country first to see available identity document options.
                </p>)}
              
              {/* Identity Document Type Dropdown */}
              {formData.country && (<div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Identity Document Type <span className="text-red-500">*</span>
                  </label>
                  <select value={formData.identityDocumentType} onChange={(e) => {
            ...
            }} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.identityDocumentType ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')}>
                    {getIdentityDocumentTypes(formData.country).map((option) => (<option key={option.value} value={option.value}>
                        {option.label}
                      </option>))}
                  </select>
              ...
              {formData.country && formData.identityDocumentType && (<div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            }} className="hidden" id="identity-document-upload"/>
                    <label htmlFor="identity-document-upload" className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-center gap-2">
                      <MdUpload className="w-4 h-4"/>
                      {(() => {
                const fieldName = getDocumentFieldName(formData.identityDocumentType);
              ...
              {formData.country && (<div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select value={formData.paymentIdentityType} onChange={(e) => {
            ...
            }} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.paymentIdentityType ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')}>
                        {getPaymentIdentityTypes(formData.country).map((option) => (<option key={option.value} value={option.value}>
                            {option.label}
                          </option>))}
                      </select>
                      {errors.paymentIdentityType && <p className="mt-1 text-sm text-red-500">{errors.paymentIdentityType}</p>}
                    </div>
                    {formData.paymentIdentityType && (<div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Payment Identity Document <span className="text-red-500">*</span>
                        </label>
                        <div className="flex items-center gap-2">
                          <input type="file" accept="image/*,.pdf" onChange={(e) => handleFileUpload('paymentIdentityDocument', e.target.files?.[0] || null)} className="hidden" id="payment-identity-upload"/>
                          <label htmlFor="payment-identity-upload" className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-center gap-2">
                            <MdUpload className="w-4 h-4"/>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.nomineeName} onChange={(e) => {
            setFormData({ ...formData, nomineeName: e.target.value });
            if (errors.nomineeName) {
                setErrors({ ...errors, nomineeName: '' });
            }
        }} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.nomineeName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter nominee name" required/>
                ...
                <div>
                  ...
                  <select value={formData.nomineeRelation} onChange={(e) => {
            setFormData({ ...formData, nomineeRelation: e.target.value });
            if (errors.nomineeRelation) {
                setErrors({ ...errors, nomineeRelation: '' });
            }
        }} className={cn('w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.nomineeRelation ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} required>
                    {relationOptions.map((option) => (<option key={option.value} value={option.value}>
                        {option.label}
                      </option>))}
                  </select>
                ...
                <div className="sm:col-span-2 lg:col-span-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <div className="w-full sm:w-40">
                      <SearchableSelect options={countryCodeOptions} value={formData.nomineePhoneCountryCode} onChange={(selectedCode) => {
        ...
        }} placeholder="Search country code..." className={errors.nomineePhoneCountryCode ? 'border-red-500' : ''} required/>
                    </div>
                    <input type="tel" value={formData.nomineePhone} onChange={(e) => {
            setFormData({ ...formData, nomineePhone: e.target.value });
            if (errors.nomineePhone) {
                setErrors({ ...errors, nomineePhone: '' });
            }
        }} className={cn('flex-1 min-w-0 px-4 py-2 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500', errors.nomineePhone ? 'border-red-500' : 'border-gray-300 dark:border-gray-600')} placeholder="Enter nominee phone" required/>
                  </div>
                  {(errors.nomineePhone || errors.nomineePhoneCountryCode) && (<p className="mt-1 text-sm text-red-500">
            ...
            <div className="flex justify-center sm:justify-end pt-4 sm:pt-6">
              <button type="submit" disabled={submitMutation.isPending} className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
...
//# sourceMappingURL=EmployeeOnboardingFormPage.js.map