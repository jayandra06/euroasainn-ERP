...
import { MdTrendingUp, MdCheckCircle, MdLightbulb, MdCalendarToday, MdStar, MdPerson, } from 'react-icons/md';
// Mock data
...
export function CustomerExperienceDashboard() {
    ...
    const totalInteractions = interactionHeatmapData.reduce((sum, month) => sum + month.week1 + month.week2 + month.week3 + month.week4, 0);
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="mt-4 space-y-3">
          {featureAdoptionData.map((feature, index) => (<div key={index} className="p-3 rounded-lg bg-[hsl(var(--secondary))]">
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" style={{ width: `${feature.adoption}%` }}/>
              </div>
            </div>))}
        </div>
      </div>
      ...
      <div className="p-6 rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/20 shadow-sm">
        ...
        <div className="space-y-3">
          {aiRecommendations.map((recommendation, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--card))] border border-blue-200 dark:border-blue-800">
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${recommendation.priority === 'high' ? 'bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300' :
...
//# sourceMappingURL=CustomerExperienceDashboard.js.map