      ...
      <div className="bg-[hsl(var(--card))] rounded-xl border border-[hsl(var(--border))] shadow-sm p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea id="welcomeEmail" value={welcomeEmail} onChange={(e) => setWelcomeEmail(e.target.value)} rows={8} className="w-full px-4 py-3 border border-[hsl(var(--border))] rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-[hsl(var(--foreground))] bg-[hsl(var(--card))] resize-y" placeholder="Welcome to {platform_name}..."/>
          ...
          <div>
            ...
            <textarea id="invoiceEmail" value={invoiceEmail} onChange={(e) => setInvoiceEmail(e.target.value)} rows={8} className="w-full px-4 py-3 border border-[hsl(var(--border))] rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-[hsl(var(--foreground))] bg-[hsl(var(--card))] resize-y" placeholder="Your invoice for {month}..."/>
            <p className="mt-2 text-xs text-[hsl(var(--muted-foreground))]">
...
//# sourceMappingURL=EmailTemplatesPage.js.map