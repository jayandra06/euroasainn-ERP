...
export function ActivityLogPage() {
    ...
    const filteredLogs = useMemo(() => {
        ...
        if (searchQuery.trim()) {
            ...
            filtered = filtered.filter(log => log.userName.toLowerCase().includes(query) ||
    ...
    const columns = [
        ...
        },
        {
            key: 'user',
            header: 'User',
            render: (log) => (<div className="flex items-center gap-3">
        ...
        },
        {
          ...
          <div className="flex items-center gap-2">
            ...
            {log.portalType && (<span className={cn('px-2 py-1 inline-flex text-xs leading-5 font-bold rounded-full', log.portalType === 'customer'
        ...
        },
        {
            key: 'organization',
            header: 'Organization',
            render: (log) => (<span className="text-sm text-[hsl(var(--muted-foreground))]">
        ...
        },
        {
            key: 'status',
            header: 'Status',
            render: (log) => (<span className={cn('px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full', log.status === 'success'
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <button onClick={handleExport} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl transition-colors font-semibold shadow-lg shadow-purple-500/30">
      ...
      <div className="p-6 rounded-2xl bg-[hsl(var(--card))]/80 backdrop-blur-xl border border-[hsl(var(--border))]/50 shadow-lg">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] focus-within:border-purple-500 dark:focus-within:border-purple-400 focus-within:ring-2 focus-within:ring-purple-500/20 transition-all">
            ...
            <input type="text" placeholder="Search activity logs..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="flex-1 bg-transparent border-none outline-none text-sm text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))]"/>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <select value={filterAction} onChange={(e) => setFilterAction(e.target.value)} className="px-4 py-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--foreground))] shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 font-medium">
            ...
            <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)} className="px-4 py-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--foreground))] shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 font-medium">
              <option value="all">All Status</option>
              <option value="success">Success</option>
              <option value="failed">Failed</option>
              <option value="pending">Pending</option>
            </select>
            <select value={filterDateRange} onChange={(e) => setFilterDateRange(e.target.value)} className="px-4 py-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--foreground))] shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 font-medium">
      ...
      {isLoading ? (<div className="p-12 text-center rounded-2xl bg-[hsl(var(--card))]/80 backdrop-blur-xl border border-[hsl(var(--border))]/50 shadow-lg">
          ...
          <DataTable columns={columns} data={filteredLogs} emptyMessage="No activity logs found."/>
        </div>)}
    </div>);
}
//# sourceMappingURL=ActivityLogPage.js.map