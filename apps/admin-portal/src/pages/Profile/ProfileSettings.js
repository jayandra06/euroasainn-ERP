...
export function ProfileSettings({ activeTab = 'password' }) {
    ...
    const tabs = [
        { id: 'password', label: 'Change/Reset Password', icon: MdLock },
        { id: 'security', label: 'Security Questions', icon: MdSecurity },
        { id: 'language', label: 'Language Selection', icon: MdTranslate },
        { id: 'timezone', label: 'Time Zone', icon: MdAccessTime },
        { id: 'date-format', label: 'Date and Time Format', icon: MdCalendarToday },
    ];
    return (<div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      ...
      <div className="space-y-2 mb-6">
        {tabs.map((tab) => {
            ...
            return (<button key={tab.id} onClick={() => handleTabChange(tab.id)} className={`w-full flex items-center justify-between px-4 py-3 rounded-lg transition-colors text-sm font-medium ${isActive
              ...
              <MdKeyboardArrowDown className={`w-5 h-5 flex-shrink-0 transition-transform duration-200 ${isActive ? 'text-gray-900 rotate-180' : 'text-gray-400'}`}/>
            </button>);
        })}
      </div>
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input type="password" id="currentPassword" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white" placeholder="Enter current password"/>
        </div>
        ...
        <div>
          ...
          <input type="password" id="newPassword" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white" placeholder="Enter new password"/>
        ...
        <div>
          ...
          <input type="password" id="confirmPassword" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white" placeholder="Confirm new password"/>
        </div>
      </div>
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <select id="securityQuestion" value={selectedQuestion} onChange={(e) => setSelectedQuestion(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white appearance-none pr-10">
            <option value="">Select a security question</option>
            {securityQuestions.map((question, index) => (<option key={index} value={question}>
                {question}
              </option>))}
          </select>
        </div>
        ...
        <div>
          ...
          <input type="text" id="securityAnswer" value={answer} onChange={(e) => setAnswer(e.target.value)} placeholder="Enter your answer" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white"/>
        </div>
      </div>
...
function LanguageSettings() {
    ...
    return (<div className="space-y-6">
      ...
      <div>
        ...
        <select id="language" value={selectedLanguage} onChange={(e) => setSelectedLanguage(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white">
...
function TimezoneSettings() {
    ...
    return (<div className="space-y-6">
      ...
      <div>
        ...
        <select id="timezone" value={selectedTimezone} onChange={(e) => setSelectedTimezone(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white">
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <select id="dateFormat" value={dateFormat} onChange={(e) => setDateFormat(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white">
            {dateFormats.map((format) => (<option key={format} value={format}>
                {format}
              </option>))}
          </select>
        </div>
        ...
        <div>
          ...
          <select id="timeFormat" value={timeFormat} onChange={(e) => setTimeFormat(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] transition-colors text-gray-900 bg-white">
