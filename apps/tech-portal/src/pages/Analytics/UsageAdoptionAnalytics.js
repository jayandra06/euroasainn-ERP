...
import { MdTrendingUp, MdPeople, MdApi, MdError, MdCheckCircle, } from 'react-icons/md';
// Mock data
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {['/api/users', '/api/payments', '/api/reports'].map((endpoint) => {
            ...
            return (<div key={endpoint} className="p-4 rounded-lg bg-[hsl(var(--secondary))]">
                <h4 className="font-semibold text-[hsl(var(--foreground))] mb-3">{endpoint}</h4>
                <div className="space-y-2">
                  {endpointData.map((data, index) => (<div key={index} className="flex items-center justify-between">
      ...
      <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <div className="space-y-4">
          {moduleAdoption.map((module, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--secondary))]">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" style={{ width: `${module.adoption}%` }}/>
              </div>
            </div>))}
        </div>
      </div>
...
//# sourceMappingURL=UsageAdoptionAnalytics.js.map