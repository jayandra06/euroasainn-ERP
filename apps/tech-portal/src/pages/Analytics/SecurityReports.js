...
import { MdSecurity, MdLock, MdWarning, MdCheckCircle, MdError, MdLocationOn, } from 'react-icons/md';
// Mock data
    ...
    return (<div className="w-full space-y-6">
      ...
      <div className="p-6 rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/20 shadow-sm">
        ...
        <div className="space-y-3">
          {failedLoginData.map((login, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--card))] border border-red-200 dark:border-red-800">
              <div className="flex items-center justify-between">
                ...
                <span className={`px-3 py-1 text-xs font-semibold rounded-full ${login.status === 'blocked'
      ...
      <div className="p-6 rounded-xl border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/20 shadow-sm">
        ...
        <div className="space-y-3">
          {vulnerabilityScans.map((scan, index) => (<div key={index} className="p-4 rounded-lg bg-[hsl(var(--card))] border border-orange-200 dark:border-orange-800">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-semibold text-[hsl(var(--foreground))]">{scan.scan}</h4>
                <span className={`px-3 py-1 text-xs font-semibold rounded-full ${scan.status === 'action_required'
                ? 'bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300'
                : 'bg-orange-100 dark:bg-orange-900 text-[hsl(var(--foreground))] font-semibold'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="p-6 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
          ...
          <div className="space-y-3">
            {accessLogSummary.map((log, index) => (<div key={index} className="p-3 rounded-lg bg-[hsl(var(--secondary))]">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div className="h-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" style={{ width: `${log.percentage}%` }}/>
                </div>
...
//# sourceMappingURL=SecurityReports.js.map