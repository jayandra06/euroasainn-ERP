...
import { MdDelete, MdEdit, MdClose, MdSearch, MdPersonAdd, MdFilterList } from "react-icons/md";
...
export function AssignRolesPage() {
  ...
  const allUsersQuery = useQuery({
    queryKey: ["all-users", FIXED_PORTAL],
    queryFn: async () => {
      const res = await authFetch(
  ...
  const usersQuery = useQuery({
    queryKey: ["users", FIXED_PORTAL, currentPage, itemsPerPage, searchQuery, roleFilter],
    queryFn: async () => {
  ...
  const assignRoleMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["all-users", FIXED_PORTAL] });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Manage user roles and permissions for Tech Portal
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end">
            <button
              disabled={!canAssign || !selectedRole || !selectedUser || assignRoleMutation.isPending}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className="p-2 rounded-lg bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          title="Edit role"
                        >
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (!canRemove) return;
                            if (confirm(`Are you sure you want to remove the role from ${u.firstName} ${u.lastName}?`)) {
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    options={roleOptions}
                    value={roleOptions.find((r) => r.value === editingRole) || null}
                    onChange={(opt: any) => setEditingRole(opt?.value || null)}
                  />
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    ...
                    disabled={!canUpdate || !editingRole || assignRoleMutation.isPending}
                    onClick={() => {
