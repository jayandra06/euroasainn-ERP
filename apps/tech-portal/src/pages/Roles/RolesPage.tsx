...
export default function RolesPage() {
  ...
  const fetchRoles = async () => {
    ...
    try {
      ...
      const res = await authFetch(`${API_URL}/roles?${params.toString()}`);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Create and manage roles with specific permissions for Tech Portal
          </p>
        </div>
      </div>
        ...
        {portal && (
          <>
            ...
            <button
              ...
              disabled={!canCreate || !roleName.trim() || isCreating}
