...
function ToastContainer({ toasts, onRemove }) {
    if (toasts.length === 0)
        return null;
    return (<div className="fixed top-20 right-4 z-[100] space-y-2">
...
function ToastItem({ toast, onRemove }) {
    ...
    return (<div className={cn('flex items-start gap-3 px-4 py-3 rounded-xl shadow-lg border backdrop-blur-sm animate-slide-in-right max-w-md min-w-[300px]', styles[toast.type])}>
